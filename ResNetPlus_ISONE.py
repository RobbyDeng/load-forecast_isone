...
if TRAIN:
    ...
    with h5py.File('results1.h5', 'w') as h5f:
...
if TRAIN:
    ...
    with h5py.File('results2.h5', 'w') as h5f:
        h5f.create_dataset('pred_list', data=pred_list)
...
if TRAIN:
    ...
    with h5py.File('results3.h5', 'w') as h5f:
        h5f.create_dataset('pred_list', data=pred_list)
...
if TRAIN:
    ...
    with h5py.File('results4.h5', 'w') as h5f:
        h5f.create_dataset('pred_list', data=pred_list)
...
if TRAIN:
    ...
    with h5py.File('results5.h5', 'w') as h5f:
        h5f.create_dataset('pred_list', data=pred_list)
